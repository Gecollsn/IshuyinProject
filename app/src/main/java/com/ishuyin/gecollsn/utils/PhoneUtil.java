...
/**
 * Created by gecollsn on 2016/4/5 15:32.
 * <p>
 * Company: zjp-company
...
public class PhoneUtil {
     ...
     * @param phoneNumber
     */
    public static String formatPhoneWithSpace(String phoneNumber) {
        ...
        if (phoneNumber.length() >= 8 && phoneNumber.length() <= 11) {
            ...
            phoneNumber = stringBuffer.insert(3, "  ").toString();
            stringBuffer = new StringBuffer(phoneNumber);
            if (phoneNumber.length() >= 9) {
                phoneNumber = stringBuffer.insert(9, "  ").toString();
            }
     ...
     * @param phoneNumber
     */
    public static String formatPhoneRemoveSpace(String phoneNumber) {
        if (phoneNumber == null) return phoneNumber;
